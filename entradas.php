...
include("verifica_login.php");
  ...
  $consulta = "SELECT entrada_id, fornecedor_nome, deposito_nome, entrada_data, entrada_quantidade, produto_nome, entrada_valor_unitario, entrada_valor_total, entrada_total FROM `entradas` LEFT JOIN fornecedores ON (fornecedores.fornecedor_id = entradas.entrada_fornecedor_id)
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $dado['entrada_data']?></td>
                  <td><?php echo $dado['entrada_quantidade']?></td>
                  <td><?php echo $dado['produto_nome']?></td>
                  <td>R$ <?php echo $dado['entrada_valor_unitario']?></td>
                  <td>R$ <?php echo $dado['entrada_valor_total']?></td>
                  <td>R$ <?php echo $dado['entrada_total']?></td>
                </tr>
                <?php } ?>
              </tbody>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="Post" action="processa_entrada.php">
