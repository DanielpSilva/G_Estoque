    ...
    <!-- Inicio do formulario -->
     <form method="Post" action="processa_empresa.php">
      ...
      <i class="fas fa-user-tie"></i>
         <input name="nome" placeholder="Nome"  type="text" id="nome">
      </div>
      
          <div class="textbox">
          <input name="razao" placeholder="Razão" type="text" id="razao">
          </div>
      
          <div class="textbox">
          <input name="cnpj" placeholder="CNPJ" type="text" id="cnpj">
          </div>
      ...
      <i class="fas fa-mobile-alt"></i>
          <input name="telefone" placeholder="Telefone" type="text" id="telefone">
          </div>
      ...
      <i class="fas fa-home"></i>
          <input name="numero" placeholder= "N° " type="text" id="numero">
      </div>
      ...
      <i class="fas fa-user"></i>
            <input name="nome_usu" placeholder="Usuario" type="text" id="nome_usu">
          </div>
