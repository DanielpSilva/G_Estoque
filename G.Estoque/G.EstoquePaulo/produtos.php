...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <td><a href="acoes/ativa_produto.php?produto=<?php echo $dado['produto_id']; ?>">Ativar</a> |
    
      <a href="/acoes/desativa_produto.php?produto=<?php echo $dado['produto_id']; ?>">Desativar</a></td>
                </tr>
                <?php } ?>
                ...
                <div class="modal-body">
                  <form method="Post" action="processa_produto.php" required>
                    ...
                    <div class="form-group row">
                      ...
                      <input name="codigo" type="text" class="form-group inputForm col-sm-8" id="codigo" required>
                    </div>

                    <div class="form-group row">
                      <label for="nome" class="col-sm-4">Nome do produto: </label>
                      <input name="nome" type="text" class="form-group inputForm col-sm-18" id="nome" required>
                    </div>
