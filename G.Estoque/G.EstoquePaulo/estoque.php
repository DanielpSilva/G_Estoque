...
$empresa = $_SESSION['idempresa'];
  ...
  $consulta = " SELECT deposito_id AS 'id', deposito_nome AS 'Nome do deposito', produto_nome AS 'Nome de produto', estoque_quantidade AS 'quantidade' ,
  estoque_custo AS 'Custo'
  FROM 
  estoque LEFT JOIN depositos ON (depositos.deposito_id = estoque.estoque_deposito_id) 
  LEFT JOIN 
